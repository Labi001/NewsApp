...
import com.labinot.bajrami.newsapp.presentation.Page
...
fun onBoardingPage(
    ...
    Column(modifier = modifier) {
        ...
        Text(text = page.title,
            ...
            color = if(isSystemInDarkTheme()) colorResource(id = R.color.display_smalln)
            else colorResource(id = R.color.display_small) )
